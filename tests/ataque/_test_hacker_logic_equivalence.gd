...
func _run() -> void:
	...
	var golden: Array[String] = [
		...
		"post_bypass_move|noise=29|used=2|bypass=1|esc=1|per=0|pos=WebServer|turn=1",
		"escalate_move|pos=AppServer|🔓 Elevación aplicado en AppServer (ruido: 51)",
		"post_escalate|noise=51|used=3|bypass=1|esc=0|per=0|pos=AppServer|turn=2",
