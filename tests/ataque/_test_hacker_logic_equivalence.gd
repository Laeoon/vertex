...
func _run() -> void:
	...
	var golden: Array[String] = [
		...
		"persist|persists={ \"WebServer\": 3 }|♻ Persistencia activa en WebServer por 3 turnos",
		...
		"post_bypass_move|noise=23|used=2|bypass=1|esc=1|per=0|pos=WebServer|turn=1",
		"escalate_move|pos=AppServer|🔓 Elevación aplicado en AppServer (ruido: 45)",
		"post_escalate|noise=45|used=3|bypass=1|esc=0|per=0|pos=AppServer|turn=2",
