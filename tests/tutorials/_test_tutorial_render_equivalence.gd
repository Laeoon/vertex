...
func _run() -> void:
	...
	var golden: Array[String] = [
		...
		"fp|center|90.0,250.0 620.0x100.0|n=2|lh=22.0",
		"fp|top|90.0,70.0 620.0x100.0",
		"fp|bottom|90.0,440.0 620.0x100.0",
		"fp|left|30.0,250.0 620.0x100.0",
		"fp|right|150.0,250.0 620.0x100.0",
		"fp|min_h|90.0,250.0 620.0x100.0",
		"fp|clamp_w|30.0,100.0 340.0x100.0",
